      ...
      <article>
        ...
        <section>
          <div>
            ...
            <p>
              Made in pure #CSS and almost all is "old properties" method. And a
              bit imagination.
              <br />
        ...
        <section>
          <div>
            <h2>
              <a href="https://escss.blogspot.com">&xi;sCSS Blog</a>
            </h2>
            <p>
              #impoCSSible inside EsCSS. A Spanish #CSS blog where the borders &
              limits of #CSS disappear.
            </p>
          </div>
        </section>
        ...
        <section>
          <div>
            ...
            <p>
              You don´t need Javascript or #CSS processors either for almost
              100% of what you want to do.
            </p>
          </div>
        </section>
        ...
        <section>
          <div>
            <h2>
              Idea from E.Bouças´s{" "}
              <a href="https://codepen.io/eduardoboucas/full/qdaOWv/">pen</a>
            </h2>
            <p>
              Without jQuery or Javascript, nor fixed position (bye IOs
              problems)
            </p>
          </div>
        </section>
        ...
        <section>
          <div>
            <h2>
              show the PEN.
              <br />
              <a href="https://escss.blogspot.com/2017/08/scroll-half-by-half-pure-css.html">
                link the POST
              </a>
            </h2>
